...
SELECT * FROM (
    ...
    GROUP BY user_id, contact_id, partner_marketplace, partner_category
    ...
    FROM 
        ...
        (SELECT 
            ...
            partner_category,
            user_id 
        FROM {{ ref('int_retention_monthly_partner_category_churns_list') }}) lcu
    WHERE
        ...
        au.partner_category = lcu.partner_category
    
    GROUP BY lcu.year_month, au.user_id, au.contact_id, au.partner_marketplace, au.partner_category
