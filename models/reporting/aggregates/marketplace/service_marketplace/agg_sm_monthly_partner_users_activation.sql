...
FROM (
    ...
    GROUP BY year_month, activation_type, partner_name -- Grouping the data by year_month and activation type to prepare for aggregation
...
GROUP BY year_month, partner_name
