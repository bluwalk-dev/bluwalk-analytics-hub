...
FROM {{ ref('agg_retention_monthly_retention_segment_users_churned') }} a
...
LEFT JOIN {{ ref('agg_retention_monthly_retention_segment_users_active') }} b ON 
    a.retention_segment = b.retention_segment AND
