SELECT
  ...
  MAX(CASE WHEN param.key = 'batch_page_id' THEN param.value.string_value ELSE NULL END) AS batch_page_id,
  MAX(CASE WHEN param.key = 'term' THEN param.value.string_value ELSE NULL END) AS term,
  MAX(CASE WHEN param.key = 'batch_ordering_id' THEN param.value.string_value ELSE NULL END) AS batch_ordering_id,
  MAX(CASE WHEN param.key = 'session_engaged' THEN param.value.string_value ELSE NULL END) AS session_engaged,
  MAX(CASE WHEN param.key = 'engaged_session_event' THEN param.value.string_value ELSE NULL END) AS engaged_session_event,
