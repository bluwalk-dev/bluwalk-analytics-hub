...
SELECT * FROM (
    ...
    WHERE au.year_month > lcu.year_month -- The condition that ensures we're looking at activity after a churn
    AND au.user_id = lcu.user_id -- Making sure we're matching the same users in both derived tables
