SELECT DISTINCT
    ...
    CAST(acceptance_rate_ex_optional AS NUMERIC) acceptance_rate_ex_optional,
    CAST(online_minutes AS INTEGER) online_minutes,
    CAST(utilization_percent AS NUMERIC) utilization_percent,
    CAST(completed_orders AS INTEGER) completed_orders,
    CAST(completion_rate_percent AS NUMERIC) completion_rate_percent,
    CAST(finished_rate_percent AS NUMERIC) finished_rate_percent, 
