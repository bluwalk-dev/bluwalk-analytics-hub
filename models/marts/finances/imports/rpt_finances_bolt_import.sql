...
SELECT
    ...
    c.sales_tax_rate,
    ROUND(gross_revenue, 2) - ROUND(net_earnings,2) gross_partner_fee,
    ...
    ROUND(net_earnings,2) amount_payout,
    ...
    ROUND(gross_revenue, 2) - ROUND(net_earnings,2) amount_intfee,
...
FROM bluwalk-analytics-hub.staging.stg_bolt_driver_earnings a
